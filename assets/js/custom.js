(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('aos')) :
  typeof define === 'function' && define.amd ? define('app', ['aos'], factory) :
  (global = global || self, factory(global.aos));
}(this, (function (aos) { 'use strict';
  ...
  jQuery(function () {
    ...
    var appController = {
      ...
      init: function () {
        ...
        } else if (document.querySelector('.post-type-archive-projects')) ; else if (document.querySelector('.page-template-page-about')) ; else if (document.querySelector('.category-news')) ; else if (document.querySelector('.search')) ;
      },
      // Whole Website Func
      stickyMenu: function () {
        ...
        jQuery('.similar-product-checkbox').click(function () {
          if (jQuery(this).is(':checked')) {
            checkboxValues = {
              ...
              category: jQuery(this).attr('value')
            };
