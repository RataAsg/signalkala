...
gulp.task('tailwindcss', () => {
	return gulp
		.src(config.styleSRCTailwind, { allowEmpty: true })
...
gulp.task('fontawesome', function () {
	return gulp.src('node_modules/@fortawesome/fontawesome-free/webfonts/*').pipe(gulp.dest('./assets/fonts/font-awesome/'));
});
...
gulp.task('vendorsJS', () => {
	return (
		gulp
			...
			// .pipe(plumber(errorHandler))
			// .pipe(rollup({ plugins: [bable(), global(), resolve(), commonjs()] }, 'umd'))
			...
			.pipe(
				notify({
					message: '\n\n:white_check_mark:  ===> VENDOR JS — completed!\n',
					onLast: true,
				})
			)
	);
...
gulp.task(
	'dev',
	gulp.parallel('tailwindcss', 'styles', 'fontawesome', 'vendorsJS', 'customJS', 'images', browsersync, () => {
...
gulp.task('prod', gulp.series('tailwindcss', 'styles-deploy', 'fontawesome', 'vendorsJS', 'customJS', 'images', 'clear-styles'));
