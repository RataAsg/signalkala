...
module.exports = {
	// Project options.
	projectURL: 'http://signalkala.local/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	styleSRCTailwind: './assets/styles/tailwind.scss', // Path to main .scss file.
	...
	// Watch files paths.
	watchStyles: ['./assets/styles/**/*.scss', '!./assets/styles/tailwind.scss'], // Path to all *.scss files inside css folder and inside them.
